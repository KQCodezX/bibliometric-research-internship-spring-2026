...
#  ),
#  year        = c(2016,2016,2020,2017,2015,2022,2016,2023,2015,2022,2023,2017,2017,2018,2021,2015,2018),
#  male        = c(  12,   6,   0,  42,  20,   0,  10,   0,   1,   7,   0,  12,   3,  10,   1,   2,   6),
#  female      = c(   0,   2,   0,   7,   8,   0,  10,   0,   0,   2,   0,   5,   3,  10,   0,   0,   2),
#  unspecified = c(   0,   0,   1,   0,   0,   5,   0,  30,   0,   0,  25,   0,   0,   0,   0,   0,   0),
